...
OWNER_ID = int(getenv("OWNER_ID", 8137865351))
...
API_KEY = getenv("API_KEY", 'NxGBNexGenBots1ee9b8') # youtube song api key
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/ic_Updates")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/Tg_dates")
